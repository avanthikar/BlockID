...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { section_id: @checkin.section_id, student_id: @checkin.student_id, time: @checkin.time } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { section_id: @checkin.section_id, student_id: @checkin.student_id, time: @checkin.time } }
