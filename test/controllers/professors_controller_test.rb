...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { name: @professor.name, pass: @professor.pass, user: @professor.user } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { name: @professor.name, pass: @professor.pass, user: @professor.user } }
